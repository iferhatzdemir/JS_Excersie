...
function squareNumber(inputNumber) {
  ...
  console.log(
    `The result of squaring the number ${inputNumber} is ${sqrtNumber}.`
  );
}
...
function percentOf(inputNumber1, inputNumber2) {
  ...
  if (percentOf > 100) {
    console.log(
      `${inputNumber1} is ${percentOf.toFixed(
        2
      )}% of ${inputNumber2}. ${inputNumber1} is gratter than ${inputNumber2}`
    );
  } else {
    console.log(
      `${inputNumber1} is ${percentOf.toFixed(
        2
      )}% of ${inputNumber2}. ${inputNumber2} is gratter than ${inputNumber1}`
    );
  }
}
//percentOf(8,4)
...
function areaOfCircle(radius) {
  ...
  console.log(
    `The area for a circle with radius ${radius} is ${areaOfCircle.toFixed(2)}`
  );
}
//areaOfCircle(12.32)
...
let question1 = `1-square that number
2-half that number
...
function readParametreInput(question) {
  ...
  readline.question(question, (input1) => {
    console.log(input1);
    readline.close();
  });
}
function Calculater(input) {
  if (input > 0 && input < 5) {
    if (input == 1) {
      ...
      let a = squareNumber(inputParameter);
      console.log(a);
    } else if (input == 2) {
    } else if (input == 3) {
    } else if (input == 4) {
    ...
    console.log("Plase, Enter between 0 and 5");
  }
}
